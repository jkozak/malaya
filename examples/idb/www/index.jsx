...
document.body.onload = function() {
    ...
    var      buildSock = function() {
        ...
        sock.onmessage = function(e) {
            var decode = function(js1) {
                var ks = Object.keys(js1);
                if (ks.length===1)
                    return [ks[0],js1[ks[0]]];
                else {
            ...
            case 'BigFigBlock':
                ...
                for (var bf in js[1]._children) {
                    ...
                    var bigFig = market.bigFigs[spec.stock] || {instrument:spec.stock};
                    if (spec.bid)
    ...
    renderMarket = function() { // only items in `market` have changed
        renderAll();
    };
    renderAll = function() {
        var main;
