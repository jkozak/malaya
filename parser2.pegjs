 ...
 * ==============
 *
 * Based on javascript grammar example from peg.js
 *
...
MemberExpression
  = head:(
    ...
    {
      return buildTree(head[0], tail, function(result, element) {
        return {
...
VariableStatement
  = bind:BindingDeclarator __ declarations:VariableDeclarationList EOS {
      return {
        type:         "VariableDeclaration",
        bind:         bind[0],      // ??? why is this an array? ???
...
IterationStatement
  ...
  / ForToken __
    "(" __
    bind:BindingDeclarator __ declarations:VariableDeclarationListNoIn __ ";" __
    test:(Expression __)? ";" __
    update:(Expression __)?
    ")" __
    body:Statement
  ...
  / ForToken __
    "(" __
    bind:BindingDeclarator __ declarations:VariableDeclarationListNoIn __
    InToken __
    right:Expression __
    ")" __
    body:Statement
...
FunctionExpression
  ...
  / params:ArrowFunctionParameterList __ "=>" __ "{" __ body:FunctionBody __ "}" {
      return {
        type:   "FunctionExpression",
        id:     null,
        params: optionalList(extractOptional(params, 0)),
  ...
  / params:ArrowFunctionParameterList __ "=>" __ expr:ConditionalExpression {
      return {
        type:   "FunctionExpression",
        id:     null,
        params: optionalList(extractOptional(params, 0)),
...
StoreExpression
  = StoreToken __ "{" __ body:StoreItem* __ "}" {
    return {
...
StoreItem
  = RuleToken __ name:Identifier? __ "(" __ head:RuleItem tail:(__ "," __ RuleItem)* __ ")" ";" __ {
    return {
      type: "RuleStatement",
      body: buildList(head, tail, 3)
      };
    }
  / expr:ArrayLiteral _ ";" __ {
    return {
      type: "InitialValue",
      value: expr
      };
  }
  / expr:ObjectLiteral _ ";" __ {
    return {
      type: "InitialValue",
      value: expr
      };
  }
  / QueryToken __ id:Identifier __ "(" args:Arguments ")" __ "[" JsonMatch WhereToken "]" {} // +++ RuleItems
...
PluginStatement
 = PluginToken name:Identifier? _ "(" plugin:PluginIdentifier _ ")" _ opts:ObjectLiteral {}
